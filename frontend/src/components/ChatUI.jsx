...
const MessageBubble = ({ message, index }) => {
  ...
  return (
    ...
    >
      ...
      {/* User avatar */}
      {isUser && (
        <div className="w-7 h-7 rounded-full bg-gradient-to-br from-slate-700 to-slate-600 flex items-center justify-center flex-shrink-0 border border-slate-600">
...
const ChatUI = ({ messages = [], loading = false }) => {
  ...
  return (
    <div className="flex-1 overflow-y-auto overscroll-contain px-4 py-4 space-y-4 bg-slate-50 dark:bg-slate-950/50 scroll-smooth">
